...
Specific impulse is inversely proportional to specific fuel consumption by the relationship Isp=1/(go*SFC) for SFC in kg/N-s and Isp = 3600/SFC for SFC in lb/lbf-hr.",
